package com.pesit.hackathon.utils;

public class StringMatcher {

	/*
	 * private final static char KOREAN_UNICODE_START = '가'; private final
	 * static char KOREAN_UNICODE_END = '힣'; private final static char
	 * KOREAN_UNIT = '까' - '가'; private final static char[] KOREAN_INITIAL =
	 * {'ㄱ', 'ㄲ', 'ㄴ', 'ㄷ', 'ㄸ', 'ㄹ', 'ㅁ', 'ㅂ', 'ㅃ', 'ㅅ' ,
	 * 'ㅆ', 'ㅇ', 'ㅈ', 'ㅉ', 'ㅊ', 'ㅋ', 'ㅌ', 'ㅍ', 'ㅎ'};
	 */
